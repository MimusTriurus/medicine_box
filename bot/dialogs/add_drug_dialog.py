...
from constants import KEY_DATE, KEY_NAME, KEY_TABLE_AID_KIT_EXPIRED, DATE_FORMAT, KEY_ID
from db_management import sql_add_drug
# from webapp.drugs_db_management import sql_get_drug_info_by_title, KEY_DRUG_ID
...
async def on_expired_date_selected(
    ...
    if current_date > selected_date:
        ...
        drug_info = None # await sql_get_drug_info_by_title(drug_name.lower())
        drug_id = None
        if drug_info:
