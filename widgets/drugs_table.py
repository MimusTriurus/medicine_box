...
from constants import ICON_TO_LEFT, ICON_TO_RIGHT
...
class DrugsTable(Group):
    ...
    def managed(self, manager: DialogManager):
        return ManagedDrugsTableAdapter(self, manager)


class ManagedDrugsTableAdapter(ManagedWidgetAdapter[DrugsTable]):
